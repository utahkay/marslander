...
public class LanderGame extends JComponent implements SpriteContainer {
    ...
    public LanderGame(int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        final LanderGame component = new LanderGame(450,450);
        frame.add(component);
